## Data (200 points)
t1 = textread('dataset/h1_train_small.csv', '%s', 'delimiter', '\n');
A=[];
B=[];
for i = 1:length(t1)
    j = findstr(t1{i}, ',')(1);
...
fprintf('|:------------:|:------------:|:------------:|:------------:|:------------:|:------------:|:------------:|\n');
fprintf('|Small|%0.3f|%0.3f|%0.3f|%0.3f|%0.3f|%0.3f|\n',X(1),X(2),X(3),X(4),X(5),X(6));
